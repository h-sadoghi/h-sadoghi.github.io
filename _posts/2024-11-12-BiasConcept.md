...
<div class="row mt-3">
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid loading="eager" path="assets/img/Blog/LossBlog/Conformity-Bias.jpg" class="img-fluid rounded z-depth-1" zoomable=true %}
    </div>
</div>
...
<div class="row mt-3">
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid loading="eager" path="assets/img/Blog/LossBlog/Gender-Bias-Training-12.4.19-3.jpg" class="img-fluid rounded z-depth-1" zoomable=true %}
    </div>
</div>
...
<div class="row mt-3">
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid loading="eager" path="assets/img/Blog/LossBlog/measurement_bias.jpg" class="img-fluid rounded z-depth-1" zoomable=true %}
    </div>
</div> 
